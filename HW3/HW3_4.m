...
% align and crop the position vectors to 300 frames 

X1 = X1(i1:i1+300); Y1 = Y1(i1:i1+300);
X2 = X2(i2:i2+300); Y2 = Y2(i2:i2+300);
X3 = X3(i3:i3+300); Y3 = Y3(i3:i3+300); 
